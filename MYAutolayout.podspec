#
#  Be sure to run `pod spec lint MYAutolayout.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
使用链式编程思想进行封装的自动布局库MYAutolayout
                   DESC
  ...
  # Or just: s.author    = "chenweinan"
  # s.authors            = { "chenweinan" => "1014949353@qq.com" }
  # s.social_media_url   = "http://twitter.com/chenweinan"
